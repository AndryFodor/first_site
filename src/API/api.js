...
export const API = {
    ...
    // метод для оформлення або знищення підписки на певного користувача із серверу (приймає id користувача, з яким виконати або delete (відписатися), або create (створити підписку - підписатися))
